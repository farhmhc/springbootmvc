...
<head>
	...
	<link href="/lib/bootstrap/example/sticky-footer-navbar/sticky-footer-navbar.css" rel="stylesheet">
...
<body>
	...
	<main class="flex-shrink-0">
	  <div class="container">
	    ...
	    <p>Back to <a href="/bootstrap/sticky-footer">the default sticky footer</a> minus the navbar.</p>
	  </div>
	</main>
