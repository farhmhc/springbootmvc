...
<head>
    ...
    <link href="/lib/bootstrap5/example/sticky-footer/sticky-footer.css" rel="stylesheet">
...
<body class="d-flex flex-column h-100">
	...
	<main class="flex-shrink-0">
	  <div class="container">
	    ...
	    <p>Use <a href="/bootstrap5/sticky-footer-navbar/">the sticky footer with a fixed navbar</a> if need be, too.</p>
	  </div>
	</main>
